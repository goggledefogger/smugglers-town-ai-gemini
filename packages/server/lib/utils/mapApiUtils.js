...
exports.getMapFeaturesAtPoint = getMapFeaturesAtPoint;
exports.responseHasRoad = responseHasRoad;
 ...
 */
function getMapFeaturesAtPoint(lon, lat) {
 ...
 */
function responseHasRoad(apiResponse) {
    ...
    return apiResponse.features.some((feature) => feature.properties?.tilequery?.layer === QUERY_LAYER || // Common structure
...
//# sourceMappingURL=mapApiUtils.js.map